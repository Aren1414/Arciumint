...
/// CHECK: This is a PDA used as mint authority signer.
pub mint_authority: UncheckedAccount<'info>,

#[account(mut)]
/// CHECK: Account created/checked by Metaplex CPI
...
fn create_metadata_for_token<'info>( ctx: &Context<MintNFT<'info>>, name: String, symbol: String, uri: String, signer: &[&[&[u8]]], ) -> Result<()> { let creator = Creator { address: ctx.accounts.payer.key(), verified: false, share: 100, };
...
#[error_code] pub enum ErrorCode { #[msg("This wallet has already minted an NFT.")] AlreadyMinted, #[msg("Invalid token program.")] InvalidTokenProgram, #[msg("Invalid MPC input data.")] InvalidMPCData, }
