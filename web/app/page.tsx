    ...
    <main className="relative min-h-screen flex flex-col text-white">
      ...
      <header className="w-full border-b border-white/10 py-3 px-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 sm:gap-4 flex-wrap justify-end">
          ...
          <button className="px-3 py-1 text-xs sm:px-4 sm:py-2 sm:text-sm lg:text-base bg-blue-600 rounded-lg hover:bg-blue-700 transition">
            Faucet (Devnet)
          </button>

          <button className="px-3 py-1 text-xs sm:px-4 sm:py-2 sm:text-sm lg:text-base bg-white/10 rounded-lg hover:bg-white/20 transition">
            Connect Wallet
          </button>
        </div>
      </header>
