export default function Home() {
  return (
    <main className="min-h-screen bg-black text-white flex flex-col">
      ...
      {/* Hero / Banner */}
      <section className="w-full h-[260px] bg-gradient-to-r from-purple-700 to-indigo-800 flex items-center justify-center text-center">
        <h2 className="text-3xl font-bold">
          Discover Your Personality. On-Chain. Powered by Arcium MPC.
        </h2>
      </section>
